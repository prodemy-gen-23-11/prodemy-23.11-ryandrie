...
function Table({ products, handleClickDiscard }) {
                                ...
                                <div className='px-4 py-3'>
                                    ...
                                    <div className='product-details-specific my-4 font-poppins'>
                                        ...
                                        <div className='flex justify-end gap-4'>
                                            <div
                                                onClick={() =>
                                                    handleClickDiscard(data.id)
                                                }
                                                className='border rounded-xl px-4 py-2 bg-red-500 text-white hover:cursor-pointer hover:bg-red-600'
                                            >
                                                Discard
                                            </div>
                                            <Link
                                                to={`/admin/editproduct/${data.id}`}
                                            >
