    ...
    return (
        <Link to={`/product/${data.id}`}>
            <div
                ...
                className='product-card overflow-hidden w-[300px] flex flex-col justify-evenly gap-2 border border-gainsboro rounded-3xl shadow-md shrink-0 product-hover my-2'
            >
